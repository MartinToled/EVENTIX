...
function getEvents(page) {
  ...
  $.ajax({
    type:"GET",
    url:"https://app.ticketmaster.com/discovery/v2/events?apikey=A2GDug9iXaR78A1N9rHla8rSwNED8lFF&classificationName=sport&sort=date,asc&locale=*&size=1&countryCode=AE&page="+page,
    async:true,
    dataType: "json",
