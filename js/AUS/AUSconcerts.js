...
function getEvents(page) {
  ...
  $.ajax({
    type:"GET",
    url:"https://app.ticketmaster.com/discovery/v2/events?apikey=A2GDug9iXaR78A1N9rHla8rSwNED8lFF&locale=*&size=1&sort=date,asc&countryCode=AU&classificationName=pop,%20r&b,%20hip-hop,%20rock,%20jazz,%20country&page="+page,
    async:true,
    dataType: "json",
