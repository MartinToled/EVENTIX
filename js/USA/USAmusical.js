...
function getEvents(page) {
  ...
  $.ajax({
    type:"GET",
    url:"https://app.ticketmaster.com/discovery/v2/events?apikey=A2GDug9iXaR78A1N9rHla8rSwNED8lFF&locale=*&sort=date,asc&countryCode=US&classificationName=musical,%20classical&size=1&page="+page,
    async:true,
    dataType: "json",
